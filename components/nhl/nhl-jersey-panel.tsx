...
function NHLJerseyContent() {
  ...
  const handleShare = async () => {
    ...
    const text = `I got ${score}/5 on NHL Jersey Numbers; play here! https://majorleaguenumbers.com/nhl`;

    if (navigator.share) {
      try {
        await navigator.share({ title: "NHL Jersey Numbers", text });
      } catch (err: any) {
...
export function NHLJerseyPanel() {
  return (
