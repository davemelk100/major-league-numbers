...
function NFLJerseyContent() {
  ...
  const handleShare = async () => {
    ...
    const text = `I got ${score}/5 on NFL Jersey Numbers; play here! https://majorleaguenumbers.com/nfl`;

    if (navigator.share) {
      try {
        await navigator.share({ title: "NFL Jersey Numbers", text });
      } catch (err: any) {
...
export function NFLJerseyPanel() {
  return (
