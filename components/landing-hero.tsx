...
function SiteDropdown({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent side="bottom" align="start" className="bg-popover text-popover-foreground w-auto p-3">
      ...
      <div className="flex flex-col lg:flex-row lg:gap-8">
        <div className="shrink-0">
          ...
          <img
            ...
            className="max-w-md w-full object-contain rounded-xl my-4"
            loading="eager"
            fetchPriority="high"
          />
        </div>
        <div className="text-sm text-muted-foreground space-y-2">
          <p>Major League Numbers is an interactive exploration platform that turns numbers into a gateway for discovery across sports and music.</p>
          <p>Instead of searching by player or artist, users start with a number and instantly uncover the people, stats, moments, and connections tied to it. This number-first approach makes exploration faster, more intuitive, and more engaging than traditional reference sites.</p>
          <p>The experience is designed to be lightweight and curiosity-driven—letting users move seamlessly between data, uncover patterns, and even explore fun hypotheticals. With features like a daily quiz and clearly attributed data sources, the platform balances depth with accessibility.</p>
          <p>At its core, Major League Numbers transforms numbers into a shared language across domains—connecting sports, music, and culture in a way that&#39;s simple to navigate and enjoyable to explore.</p>
        </div>
      </div>
    </div>
  );
