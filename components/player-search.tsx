...
export function PlayerSearch() {
  ...
  return (
    <div className="relative w-full">
        ...
        <Card className="absolute top-full mt-2 w-full z-50 max-h-80 overflow-auto">
          <CardContent className="p-2">
            ...
            {results.teams.length > 0 && (
              <>
                <p className="text-xs font-medium text-muted-foreground px-2 py-1">Teams</p>
            ...
            {results.players.length > 0 && (
              <>
                <p className="text-xs font-medium text-muted-foreground px-2 py-1 mt-2">Players</p>
      ...
      {isOpen && query.length >= 2 && results.teams.length === 0 && results.players.length === 0 && !isLoading && (
