...
export function SiteSideProjectsContent() {
  ...
  const getTitle = () => {
    if (isE6) return "Related Labels & Projects";
  ...
  const getDescription = () => {
    if (isE6) return "Labels and studios connected to the Elephant 6 Recording Company collective.";
          ...
          <Card key={project.name}>
            ...
            <CardContent className="space-y-3 pb-6">
              ...
              {("url" in project && project.url) || ("discographyUrl" in project && project.discographyUrl) ? (
                ...
                >
                  {isAmrep || isRev || isE6 ? "Visit site" : "View discography"}
                </a>
              ) : null}
            </CardContent>
          </Card>
